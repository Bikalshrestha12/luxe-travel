...
const STATS = [
  ...
  },
  {
    ...
    suffix: "+",
    label: "Luxury Hotels",
    description: "Rigorously curated",
  },
  {
    value: 98,
    suffix: "%",
    label: "Satisfaction Rate",
    description: "From verified guests",
  },
  {
    value: 12,
    suffix: "K+",
...
export function StatsSection() {
  ...
  useEffect(() => {
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        forceRef.current?.setAttribute("data-triggered", "true");
      },
    });
  }, []);
  ...
  return (
    <section ref={sectionRef} className="relative py-32">
      <div ref={forceRef} className="max-w-350 mx-auto px-6 lg:px-12">
        <div
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(200,146,15,0.08) 0%, transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            {STATS.map((stat, i) => (
              <div key={stat.label} className="text-center">
                <div
                  className="text-5xl lg:text-6xl font-light text-gradient-gold mb-3"
                  style={{ fontFamily: "var(--font-cormorant)" }}
                >
                  <CountUp
                    value={stat.value}
